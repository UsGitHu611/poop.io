...
import {
  ...
  VIEW_TITLE,
  VIEW_DESCRIPTION,
} from "@/constants/viewTransitionNames";
  ...
  return (
    <motion.li
      ...
      className={clsx(
        ...
        isSelected
          ? "outline-blue-500"
          : "outline-transparent hover:outline-cool-50",
        "outline-2"
      )}
      initial={{
        scale: 0,
      ...
      >
        {({ isTransitioning }) => (
          <>
            ...
            <p
              className="truncate max-w-prose text-gray-600 dark:text-gray-300 mb-3"
              style={{
            ...
            {!isMobile ? (
              <div className="flex justify-between items-center">
                ...
                <span className="text-[hsl(0_0%_46%)] text-sm">
                  {createdAt}
                </span>
              </div>
            ) : (
              <span className="text-[hsl(0_0%_46%)] text-sm ml-auto">
                {createdAt}
              </span>
            )}
          </>
